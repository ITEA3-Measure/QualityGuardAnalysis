...
describe('Service Tests', () => {
    ...
    describe('GuardCondition Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GuardConditionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/guard-conditions';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GuardCondition', () => {

                let entity: GuardCondition;
                service.find(123).subscribe((_entity: GuardCondition) => {
                    entity = _entity;
                });
