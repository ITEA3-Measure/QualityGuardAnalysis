...
export class QualityGuardService {
    ...
    create(qualityGuardConfiguration: QualityGuard): Observable<QualityGuard> {
        const copy = this.convert(qualityGuardConfiguration);
    ...
    update(qualityGuardConfiguration: QualityGuard): Observable<QualityGuard> {
        const copy = this.convert(qualityGuardConfiguration);
     ...
     */
    private convert(qualityGuardConfiguration: QualityGuard): QualityGuard {
        const copy: QualityGuard = Object.assign({}, qualityGuardConfiguration);
        return copy;
    }
}
