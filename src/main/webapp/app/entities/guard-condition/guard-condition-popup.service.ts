...
@Injectable()
export class GuardConditionPopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.guardConditionService.find(id).subscribe((guardCondition) => {
                    this.ngbModalRef = this.guardConditionModalRef(component, guardCondition);
                    resolve(this.ngbModalRef);
                });
            } else {
                // setTimeout used as a workaround for getting ExpressionChangedAfterItHasBeenCheckedError
                setTimeout(() => {
                    this.ngbModalRef = this.guardConditionModalRef(component, new GuardCondition());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    guardConditionModalRef(component: Component, guardCondition: GuardCondition): NgbModalRef {
